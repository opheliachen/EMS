...
namespace EMSSystem.Functions
{
    class DataAccess
    {
        ...
        {
            dbConnString = new DBConnectionString();
                    ...
                    foreach (DataRow row in dsWholeData.Tables[0].Rows)
                    {
                        if (tableName == "Class")
                        {
                            ...
                            //{
                                ...
                                classSets.Add(new ClassDefinition(row["ID"].ToString(), row["ClassCategoryID"].ToString(), row["Name"].ToString(),
                                                                  ...
                                                                  int.Parse(row["Price"].ToString()), row["ClassStatus"].ToString(), row["Teacher"].ToString(),
                                                                  int.Parse(row["MaterialFee"].ToString()), int.Parse(row["ApplyFee"].ToString()), row["Note"].ToString(), 
                                                                  char.Parse(row["IsDeleted"].ToString())));
                            //}
                        }
                        else if (tableName == "ClassCategory")
                            classCateSets.Add(new ClassCategoryDefinition(int.Parse(row["ID"].ToString()), row["Name"].ToString()));
                            ...
                            companyInfo = new CompanyInfoDefinition(row["CompanyName"].ToString(), row["CompanyManager"].ToString(),
        ...
        //Student Data
        public StudentDefinition SelectStudentDataByID(string studentID)
        {
            OdbcDataAdapter adapterClass;
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsClassData.Tables[0].Rows)
                    {
                        ...
                        studentData = new StudentDefinition(int.Parse(row["ID"].ToString()).ToString("00000000"), StaticFunction.GetEncodingString(row["Name"].ToString()), row["Sex"].ToString(),
                                                            row["DateOfBirth"].ToString(), row["SocialNumber"].ToString(), row["StartDate"].ToString(), row["School"].ToString(),
                                                            row["StudyYear"].ToString(), StaticFunction.GetEncodingString(row["FatherName"].ToString()), row["FatherWork"].ToString(),
                                                            StaticFunction.GetEncodingString(row["MotherName"].ToString()), row["MotherWork"].ToString(), sibling[0], sibling[1], sibling[2], sibling[3],
                                                            row["InChargePerson"].ToString(), row["InChargePersonHomePhone"].ToString(), row["CompanyPhone"].ToString(),
                                                            row["InChargePersonMobile"].ToString(), row["EmergencyPerson"].ToString(), row["EmergencyPhone"].ToString(),
                                                            row["Address"].ToString(), row["PostCode"].ToString(), int.Parse(row["PrePaid"].ToString()), '0');
                    }
        ...
        public List<StudentDefinition> SelectStudentDataByName(string studentName)
        {
            OdbcDataAdapter adapterClass;
            DataSet dsClassData = new DataSet("Student");
        ...
        public ClassDefinition SelectClassDataByIDorName(string classItemName, string classItemValue)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    {
                        int currentStudentNumber = int.Parse(CountStudentNumberByClassID(row["ID"].ToString()).ToString());
                        classData = new ClassDefinition(row["ID"].ToString(), row["ClassCategoryName"].ToString(), row["Name"].ToString(),
                                                        func.ChangeDateFormatForMySql(row["StartDate"].ToString()),
                                                        func.ChangeDateFormatForMySql(row["EndDate"].ToString()),
                                                        int.Parse(row["ClassPeriod"].ToString()), row["ClassDay"].ToString(), currentStudentNumber,
                                                        int.Parse(row["Price"].ToString()), row["ClassStatus"].ToString(), row["Teacher"].ToString(),
                                                        int.Parse(row["MaterialFee"].ToString()), int.Parse(row["ApplyFee"].ToString()), row["Note"].ToString(), '0');
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStaffData.Tables[0].Rows)
                    {
                        ...
                        staffData = new StaffDefinition(row["ID"].ToString(), int.Parse(row["StaffRole"].ToString()), row["StaffTypeID"].ToString(), row["Name"].ToString(), row["EnglishName"].ToString(),
                                                        startDate, endDate, int.Parse(row["LaborCover"].ToString()), int.Parse(row["HealthCover"].ToString()),
                                                        int.Parse(row["GroupCover"].ToString()), row["Note"].ToString(), char.Parse(row["IsDeleted"].ToString()));
                    }
        ...
        public int SelectStudentInClassIDByIDs(int studentID, string classID)
        {
            OdbcDataAdapter adapterStudentInClass;
            DataSet dsStudentInClassData = new DataSet("StudentInClass");
            List<StudentInClassDefinition> studentInClassSets = new List<StudentInClassDefinition>();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    adapterStudentInClass.SelectCommand = new OdbcCommand(sSQL, conn);
                    adapterStudentInClass.SelectCommand.CommandType = CommandType.StoredProcedure;
                    return int.Parse(adapterStudentInClass.SelectCommand.ExecuteScalar().ToString());
                }
            }
            catch
            {
        ...
        public int SelectStudentInClassIDByIDsForStudentPayment(int studentID, string classID)
        {
            OdbcDataAdapter adapterStudentInClass;
            DataSet dsStudentInClassData = new DataSet("StudentInClass");
            List<StudentInClassDefinition> studentInClassSets = new List<StudentInClassDefinition>();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentSelectClassData.Tables[0].Rows)
                    {
                        ...
                        studentSelectClassData.ClassName = row["ClassName"].ToString();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentPaymentData.Tables[0].Rows)
                    {
                        ...
                        studentPaymentData.ClassName = row["ClassName"].ToString();
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsClassPaymentData.Tables[0].Rows)
                    {
                        ...
                        if (isTrue) 
                        {
                            ...
                            classPaymentData.ClassName = row["ClassName"].ToString();
                            ...
                            classPaymentData.PaymentType = row["PayType"].ToString();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    var tempClassPayment = from c in classPaymentSets
                                           orderby DateTime.Parse(c.PayDate) descending
                                           select c;
        ...
        public ClassDefinition SelectStudentHaveToRefundListByClassID(string classID)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentRefundData.Tables[0].Rows)
                    {
                        classData = new ClassDefinition(row["ID"].ToString(), "", row["Name"].ToString(),
                                                        func.ChangeDateFormatForMySql(row["StartDate"].ToString()),
                                                        func.ChangeDateFormatForMySql(row["EndDate"].ToString()),
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentRefundData.Tables[0].Rows)
                    {
                        ...
                        studentRefundData.ClassName = row["ClassName"].ToString();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentRefundData.Tables[0].Rows)
                    {
                        ...
                        studentRefundData.RefundDate = func.ChangeDateFormatForMySql(row["RefundDate"].ToString());
                        studentRefundData.Refunded = int.Parse(row["Refund"].ToString());
                        studentRefundData.Receiver = row["Receiver"].ToString();
                        studentRefundData.RefundType = row["RefundType"].ToString();
                        studentRefundSets.Add(studentRefundData);
                    }
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentRefundData.Tables[0].Rows)
                    {
                        ...
                        studentRefundDetailData.ClassName = row["ClassName"].ToString(); ;
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsDailyExpanseData.Tables[0].Rows)
                    {
                        ...
                        dailyExpanseData.ExpanseCategoryName = row["ExpanseCategoryName"].ToString();
                        dailyExpanseData.ShopName = row["ShopName"].ToString();
                        dailyExpanseData.ItemName = row["ItemName"].ToString();
                        dailyExpanseData.UnitPrice = int.Parse(row["UnitPrice"].ToString());
                        ...
                        dailyExpanseData.InsertStaffName = row["InsertStaffName"].ToString();
                        ...
                        if (row["UpdateStaffID"] != null && row["UpdateStaffID"].ToString() != "" && int.Parse(row["UpdateStaffID"].ToString()) != 0)
                        {
                            ...
                            dailyExpanseData.UpdateStaffName = row["UpdateStaffName"].ToString();
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsSystemLogsData.Tables[0].Rows)
                    {
                        ...
                        systemLogsData.StaffName = row["StaffName"].ToString();
                        systemLogsData.Action = row["Action"].ToString(); ;
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentPaymentData.Tables[0].Rows)
                    {
                        ...
                        recordData.Data2Name = row["ClassName"].ToString();
                        ...
                        recordData.Note2 = row["PayType"].ToString();
                        recordSets.Add(recordData);
                    }
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    foreach (DataRow row in dsStudentPaymentData.Tables[0].Rows)
                    {
                        ...
                        recordData.Note1 = row["Event"].ToString();
                        recordSets.Add(recordData);
                    }
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    if (sSQL.IndexOf("Class") > -1)
                    {
                        foreach (DataRow row in dsStudentRefundData.Tables[0].Rows)
                        {
                            ...
                            recordData.Discount = int.Parse(row["Discount"].ToString());
                            recordData.Data1Name = row["StaffName"].ToString();
                            recordSets.Add(recordData);
                        }
                    }
                    else
        ...
        public void InsertStudentInClass(StudentInClassDefinition studentInClassData)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    sSQL = "Call qryInsertStudentInClass(" + int.Parse(studentInClassData.StudentID) + ", '" + 
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    sSQL = "Call qryInsertPrepaidHistory(" + int.Parse(studentPrepaidData.StudentID) + ", '" + func.ChangeDateFormatForMySql(DateTime.Now) + "', " + studentPrepaidData.InMoney +
                                                             ", " + studentPrepaidData.OutMoney + ", '" + studentPrepaidData.Events + "')";
        ...
        public void InsertDailyExpanse(ExpanseDefinition dailyExpanseData)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    sSQL = "Call qryInsertExpanse('" + dailyExpanseData.ExpanseCategoryName + "', '" + dailyExpanseData.InsertStaffName + "', '" + dailyExpanseData.ItemName + "', '" +
                                                                       dailyExpanseData.ShopName + "', " + dailyExpanseData.UnitPrice + ", " + dailyExpanseData.Quantity + ")";
        ...
        public void InsertSystemLog(SystemLogsDefinition systemLogs)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    sSQL = "Call qryInsertSystemlogs('" + systemLogs.StaffName + "', '" + systemLogs.Date + "', '" + systemLogs.Action + "')";
        ...
        public void UpdateDailyExpanse(ExpanseDefinition dailyExpanseData)
        {
            ...
            try
            {
                ...
                using (conn = new OdbcConnection(connectString))
                {
                    ...
                    sSQL = "Call qryUpdateExpanseByID(" + dailyExpanseData.ID + ", '" + dailyExpanseData.ExpanseCategoryName + "', '" + dailyExpanseData.UpdateStaffName + "', '" +
                                                                              dailyExpanseData.ItemName + "', '" + dailyExpanseData.ShopName + "', " + dailyExpanseData.UnitPrice + ", " + 
                                                                              dailyExpanseData.Quantity + ")";
