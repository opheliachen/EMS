...
CREATE TABLE `student` (
  ...
  `InChargePerson` varchar(20) NOT NULL,
  `InChargePersonHomePhone` varchar(45) NOT NULL,
  ...
  `EmergencyPerson` varchar(10) NOT NULL,
  `EmergencyPhone` varchar(45) NOT NULL,
  `PostCode` varchar(5) NOT NULL,
  `PrePaid` int(10) unsigned NOT NULL,
  `Sex` varchar(5) NOT NULL,
  `InChargePersonMobile` varchar(45) NOT NULL,
  `StartDate` varchar(10) NOT NULL,
  `Sibling` varchar(45) NOT NULL,
...
CREATE DEFINER=`root`@`localhost` FUNCTION `qryInsertStudent`(student_Name Text,
                                                              ...
                                                              student_StudyYear varchar(10),
                                                              student_FatherName Text,
                                                              student_FatherWork varchar(45),
                                                              student_MotherName Text,
                                                              student_MotherWork varchar(45),
                                                              student_Sibling varchar(45),
                                                              student_InChargePerson varchar(20),
                                                              student_InChargePersonHomePhone varchar(45),
                                                              student_InChargePersonCompanyPhone varchar(45),
                                                              student_InChargePersonMobile varchar(45),
                                                              student_EmergencyPerson varchar(10),
                                                              student_EmergencyPhone varchar(45),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryUpdateStudentByID`(student_ID int,
                                                                   ...
                                                                   student_MotherWork varchar(45),
                                                                   student_Sibling varchar(45),
                                                                   student_InChargePerson varchar(10),
                                                                   student_InChargePersonHomePhone varchar(45),
                                                                   student_InChargePersonCompanyPhone varchar(45),
                                                                   student_InChargePersonMobile varchar(45),
                                                                   student_EmergencyPerson varchar(10),
