...
CREATE TABLE `classpayment` (
  ...
  `StudentInClassID` int(10) unsigned NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `student` (
  ...
  `InChargePerson` varchar(50) NOT NULL,
  `InChargePersonHomePhone` varchar(500) NOT NULL,
  `School` varchar(500) NOT NULL,
  `Address` text NOT NULL,
  `IsDeleted` char(1) NOT NULL,
  `StudyYear` varchar(100) NOT NULL,
  `FatherName` varchar(100) NOT NULL,
  `FatherWork` varchar(45) NOT NULL,
  `MotherName` varchar(100) NOT NULL,
  `MotherWork` varchar(45) NOT NULL,
  `EmergencyPerson` varchar(100) NOT NULL,
  `EmergencyPhone` varchar(500) NOT NULL,
  `PostCode` varchar(5) NOT NULL,
  `PrePaid` int(10) unsigned NOT NULL,
  `Sex` varchar(50) NOT NULL,
  `InChargePersonMobile` varchar(500) NOT NULL,
  `StartDate` varchar(10) NOT NULL,
  `Sibling` varchar(50) NOT NULL,
  `SocialNumber` varchar(100) NOT NULL,
  `CompanyPhone` varchar(500) NOT NULL,
  PRIMARY KEY (`ID`)
...
DROP TABLE IF EXISTS `educatemanagement`.`studentinclass`;
CREATE TABLE  `educatemanagement`.`studentinclass` (
  `StudentID` int(10) unsigned NOT NULL,
  `ClassID` varchar(10) NOT NULL,
  `Discount` int(10) unsigned NOT NULL,
  `IsDeleted` char(1) NOT NULL,
...
CREATE DEFINER=`root`@`localhost` FUNCTION `qryInsertClassRefundedWithoutID`(classRefund_SubID int,
                                                                             ...
                                                                             classRefund_StaffEngName varchar(20),
                                                                             classRefund_Discount int,
                                                                             classRefund_Refunded int,
                                                                             classRefund_RefundDate Date,
                                                                             classRefund_Receiver varchar(45),
                                                                             classRefund_RefundType varchar(45)) RETURNS int(11)
BEGIN
  Declare newID int;
  Declare staffID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryInsertStaff`(staff_TypeName varchar(20),
                                                             staff_Name varchar(20),
                                                             staff_EngName varchar(20),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryInsertStudent`(student_Name varchar(100),
                                                              student_Sex varchar(50),
                                                              student_DateOfBirth varchar(50),
                                                              student_SocialNumber varchar(100),
                                                              student_StartDate varchar(10),
                                                              student_School varchar(500),
                                                              student_StudyYear varchar(100),
                                                              student_FatherName varchar(100),
                                                              student_FatherWork varchar(45),
                                                              student_MotherName varchar(100),
                                                              student_MotherWork varchar(45),
                                                              student_Sibling varchar(50),
                                                              student_InChargePerson varchar(50),
                                                              student_InChargePersonHomePhone varchar(500),
                                                              student_InChargePersonCompanyPhone varchar(500),
                                                              student_InChargePersonMobile varchar(500),
                                                              student_EmergencyPerson varchar(100),
                                                              student_EmergencyPhone varchar(500),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryListAvailableStudentInClassID`() RETURNS int(11)
BEGIN
  Declare newStudentInClassID int;
  Declare studentInClassCount int;
  Set newStudentInClassID = 0;

  Repeat
    Set newStudentInClassID = newStudentInClassID + 1;
    Set studentInClassCount = (Select Count(*) As StudentInClassCount From StudentInClass Where ID = newStudentInClassID);
    Until studentInClassCount = 0
  End Repeat;

  Return newStudentInClassID;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryListExpanseCategoryIDByName`(expanseCate_Name varchar(45)) RETURNS int(11)
BEGIN
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryListStaffIDByEnglishName`(staff_EngName varchar(20)) RETURNS int(11)
BEGIN
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` FUNCTION `qryListStaffTypeIDByName`(staffType_Name varchar(20)) RETURNS int(11)
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertClassPayment`(classPayment_StudentID int,
                                                                    classPayment_ClassID varchar(10),
                                                                    classPayment_StudentInClassID int,
                                                                    classPayment_StaffEngName varchar(20),
                                                                    classPayment_Paid int,
                                                                    classPayment_PayDate Date,
                                                                    classPayment_PaymentType varchar(10))
BEGIN
  Declare newID int;
  Declare staffID int;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertClassRefunded`(classRefund_ID int,
                                                                     ...
                                                                     classRefund_RefundDate Date,
                                                                     classRefund_Receiver varchar(45),
                                                                     classRefund_RefundType varchar(45))
BEGIN
  Declare staffID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertExpanse`(expanse_ExpanseCategoryName varchar(45),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertExpanseCategory`(expanseCate_Name varchar(45))
BEGIN
  Declare newID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertRoom`(room_ClassRoom varchar(30),
                                                            room_SeatSpace int)
BEGIN
  Declare newID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertStaffAccount`(staffAccount_StaffEngName varchar(20),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertStaffType`(staffType_Name varchar(30))
BEGIN
  Declare newID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertStudentInClass`(studentInClass_StudentID int,
                                                                      studentInClass_ClassID varchar(10),
...
BEGIN
  ...
  Set newID = (Select qryListAvailableStudentInClassID());
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryInsertSystemlogs`(systemlogs_StaffEngName varchar(20),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListClassByName`(class_Name varchar(45))
BEGIN
  SELECT ID,
         Name,
         (Select Name From ClassCategory Where ID = ClassCategoryID) As ClassCategoryName,
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListClassByNameAndEndDate`(class_Name varchar(45))
BEGIN
  SELECT ID,
         Name,
         (Select Name From ClassCategory Where ID = ClassCategoryID) As ClassCategoryName,
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListClassIDByName`(class_Name varchar(45))
BEGIN
  SELECT ID
  FROM Class
  WHERE Name Like (class_Name);
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListClassNameByClassCategoryName`(class_ClassCategoryName varchar(30))
BEGIN
  SELECT Name
  FROM Class
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListExpanseIDByItemName`(expanse_ItemName varchar(45))
BEGIN
  SELECT ID
  FROM Expanse
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListRoomIDByClassRoom`(room_ClassRoom varchar(45))
BEGIN
  SELECT ID
  FROM Room
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStaffAccountByEnglishName`(staff_EngName varchar(20))
BEGIN
  Declare staffAccount_staffID int;
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStaffAccountIDByStaffEnglishName`(staffAccount_StaffEngName varchar(20))
BEGIN
  Declare staffAccount_staffID int;
  Set staffAccount_staffID = (Select qryListStaffIDByEnglishName(staffAccount_StaffEngName));
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStaffByEnglishName`(staff_EngName varchar(20))
BEGIN
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStaffByName`(staff_Name varchar(45))
BEGIN
  SELECT *, (Select Role From StaffRole Where ID = Staff.StaffRole) As Role
  FROM Staff
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStaffIDByName`(staff_Name varchar(45))
BEGIN
  SELECT ID
  FROM Staff
  WHERE Name Like (staff_Name);
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStudentByClassName`(class_Name varchar(45))
BEGIN
  SELECT *
  FROM Student
  WHERE ID In (Select Distinct StudentID From StudentInClass
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStudentByName`(Student_Name varchar(20))
BEGIN
  SELECT *
  FROM Student
...
BEGIN
  ...
  Where sc.StudentID = student_ID
    And IsDeleted = '1'
    And IsRefund = '0'
    And 0 < IFNULL((Select Sum(Paid) From ClassPayment Where StudentID = sc.StudentID And ClassID = sc.ClassID), 0)
    Group By sc.ClassID;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStudentHaveToRefundClassByClassName`(class_Name varchar(45))
BEGIN
  Select Distinct *
   From Class
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryListStudentIDByName`(student_Name varchar(500))
BEGIN
  SELECT ID
  FROM Student
  WHERE Name Like (student_Name);
...
BEGIN
  ...
  From StudentInClass sc
  Where StudentID = student_ID
    And Discount < (Select (Select qryListNeedToPayMoneyByIDs(StudentID, ClassID)+ sc.MaterialFee + ApplyFee) - IFNULL((Select Sum(Paid) From ClassPayment Where StudentID = student_ID And ClassID = sc.ClassID), 0)
                    From Class
                    Where ID = sc.ClassID)
    And IsDeleted = '0';
END $$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryUpdateClassTimeByID`(classTime_ID int,
                                                                     classTime_ClassName varchar(45),
                                                                     classTime_Time varchar(30))
BEGIN
  Declare classID int;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `qryUpdateStudentByID`(student_ID int,
                                                                   ...
                                                                   student_Sex varchar(50),
                                                                   student_DateOfBirth varchar(500),
                                                                   student_SocialNumber varchar(500),
                                                                   student_StartDate varchar(10),
                                                                   student_School varchar(500),
                                                                   student_StudyYear varchar(100),
                                                                   student_FatherName varchar(500),
                                                                   student_FatherWork varchar(45),
                                                                   student_MotherName varchar(500),
                                                                   student_MotherWork varchar(45),
                                                                   student_Sibling varchar(500),
                                                                   student_InChargePerson varchar(500),
                                                                   student_InChargePersonHomePhone varchar(500),
                                                                   student_InChargePersonCompanyPhone varchar(500),
                                                                   student_InChargePersonMobile varchar(500),
                                                                   student_EmergencyPerson varchar(500),
                                                                   student_EmergencyPhone varchar(500),
                                                                   student_Address Text,
                                                                   student_PostCode varchar(5))
BEGIN
...
Drop Table IF EXISTS `educatemanagement`.`qrylistneedtopaystudent`;
CREATE OR REPLACE VIEW `educatemanagement`.`qrylistneedtopaystudent` AS
  Select StudentID,
         (Select Name From Student Where ID = sc.StudentID) AS StudentName,
         ClassID,
         (Select Name From Class Where ID = sc.ClassID) AS ClassName,
...
Drop Table IF EXISTS `educatemanagement`.`qrylistneedtopaytotalstudent`;
CREATE OR REPLACE VIEW `educatemanagement`.`qrylistneedtopaytotalstudent` AS
  Select Distinct StudentID,
         (Select Name From Student Where ID = sc.StudentID) AS StudentName,
         Count(ClassID) As ChosenClass,
...
Drop Table IF EXISTS `educatemanagement`.`qryliststaffrole`;
CREATE OR REPLACE VIEW `educatemanagement`.`qryliststaffrole` AS
  Select ID, MatchName
  From   StaffRole;
